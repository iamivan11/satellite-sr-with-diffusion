...
try:
    ...
    try:
        from skimage.feature import greycomatrix as graycomatrix  # type: ignore[attr-defined]
        from skimage.feature import greycoprops as graycoprops
    except Exception as e:  # pragma: no cover
        raise SystemExit(
            "scikit-image is required (with texture features). "
            "Try: pip install --upgrade scikit-image"
        ) from e
