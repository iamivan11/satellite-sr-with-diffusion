...
class GaussianDiffusion(nn.Module):
    ...
    def p_losses(self, x_in, noise=None, return_reconstruction=False):
        ...
        if not return_reconstruction:
            ...
            pred_x_start_dwt_residual = (x_noisy - (1 - continuous_sqrt_alpha_cumprod.view(-1, 1, 1, 1)**2).sqrt() * predicted_noise) / continuous_sqrt_alpha_cumprod.view(-1, 1, 1, 1)
    ...
    def forward(self, x, return_reconstruction=False, *args, **kwargs):
        return self.p_losses(x, return_reconstruction=return_reconstruction, *args, **kwargs)